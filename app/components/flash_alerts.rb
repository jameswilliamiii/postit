...
class Components::FlashAlerts < Components::Base
  ...
  def find_alert_class(variant)
    base_class = "
      flex items-center -mb-10 opacity-100 max-h-full transition-all ease-in-out duration-700 overflow-hidden
      w-max py-2 rounded-full bg-white dark:bg-gray-800 shadow-md z-50
    "
